                  ...
                  child: Column(
                    children: [
                      ...
                      Row(children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(book.title, style: const TextStyle(fontWeight: FontWeight.bold),), Text(book.address), Text(book.distance, style: const TextStyle(color: Colors.white12)),Row(children: [book.rowStar,book.rowStar,book.rowStar,book.rowStar,],)
                        ],)
