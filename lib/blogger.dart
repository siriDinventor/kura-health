...
class _BlogAppState extends State<BlogApp>{
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Header(
          ...
          child2: ListView.builder(itemCount: blogList.length, itemBuilder: (context, index){
            final book = blogList[index];
            return Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(child: Text(book.title, style: const TextStyle(fontSize: 20,))),
          ...
          // child2: SizedBox(
          //   child: ListView.builder(itemCount: allBooks.length,itemBuilder: (context, index){
          //     final book = allBooks[index];
          //     return Container(color: Colors.cyanAccent, padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 20),
          //         child: Column(
          //           children: [
          //             ListTile(
          //               minLeadingWidth: 100,
  ...
  void searchBook(String query) {
    final suggestions = allBlog.where((book) {
      final bookTitle = book.title.toLowerCase();
      final input = query.toLowerCase();
      return bookTitle.contains(input);
    }).toList();
    setState(() => blogList = suggestions);
  }
}
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            setState(() {
                              allBlog.add(Book(title: myController.text, urlImage: linkController.text));
                            });
                            // int hour;
                            // int minutes;
